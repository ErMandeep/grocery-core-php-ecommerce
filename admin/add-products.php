										...
										<div class="form-wrap">
											<form action="#"  method="post" enctype="multipart/form-data">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" name="market_price" class="form-control" id="exampleInputuname" placeholder="153">
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Our Price</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="ti-money"></i></div>
																<input type="text" name="price" class="form-control" id="exampleInputuname" placeholder="153">
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																<input type="number" name="product_quantity" class="form-control" id="exampleInputuname" placeholder="5">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea name="description" class="form-control" rows="4">Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. but the majority have suffered alteration in some form, by injected humour</textarea>
														</div>
													</div>
												</div>
												<!--/row-->
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="fileupload btn btn-info btn-anim"><i class="fa fa-upload"></i><span class="btn-text">Upload</span>
															<input type="file" class="upload" name="featured_img" id="imgInp" required>
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<input type="file" class="upload" name="image[]" multiple="multiple" required>
														</div>
													</div>
												</div>
												<div class="seprator-block"></div>
												<!-- <h6 class="txt-dark capitalize-font"><i class="icon-notebook mr-10"></i>general info</h6> -->
												<hr>
											...
											<!-- 	<div class="row">
												...
												<div class="form-actions">
													<input type="submit" name="publish" class="btn btn-success btn-icon left-icon mr-10" value="save">
