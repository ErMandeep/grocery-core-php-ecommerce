...
<td><center>
 <a href="edit-products.php?id={$row['id']}" class="btn btn-primary btn-xs">Edit </a> 
...
$query = query("INSERT INTO products(product_name, product_category_id, price, description, featured_img) VALUES('{$product_name}', '{$product_category_id}', '{$price}', '{$description}', '{$name1}')");
$last_id = last_id();
confirm($query);
