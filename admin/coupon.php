...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit" data-whatever="">Create Coupon</button>												
									</h6>
								</div>
								<div class="clearfix"></div>
							</div>
...
$query = query("SELECT * FROM coupon");
confirm($query);
...
$used = $row['used'];
 ...
 ?>					
													...
													<tr>
														<td>B<?php echo $row['codes']; ?></td>
														<!-- <td>#85457891</td> -->
														<td>
														<span class="label label-default font-weight-100"><?php echo $used; ?></span>
														</td>
														<td>Rs. <?php echo $amount; ?></td>
														<!-- <td>28</td> -->
														<!-- <td>01-10-2016</td> -->
														<td>
															<?php echo time_elapsed_string($date); ?>
														</td>
														<td> 
															<a href="delete_coupon.php?id=<?php echo $id; ?>" onclick="return confirm('Are you sure?')" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h5 class="modal-title" id="edit">Enter Discount Amount</h5>
		</div>
		<div class="modal-body">
			<form method="post">
				<div class="form-group">
					...
					<input type="number" class="form-control" name="amount" placeholder="Rs. 100">
