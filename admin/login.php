...
<!-- Mirrored from hencework.com/theme/kenny/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Jan 2019 09:54:59 GMT -->
<head>
		<meta charset="UTF-8" />
														...
														<form action="#" method="post">
															<div class="form-group">
																...
																<div class="input-group">
																	<input type="text" class="form-control" name="username" required="" id="exampleInputEmail_2" placeholder="Enter email">
															...
															<div class="form-group">
																...
																<div class="input-group">
																	<input type="password" class="form-control" name="txtpassword" required="" id="exampleInputpwd_2" placeholder="Enter pwd">
